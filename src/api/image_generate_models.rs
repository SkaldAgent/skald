...
use crate::image_generate::{ImageGenerateModelInfo, ImageGenerateModelRecord};
...
pub async fn list_models(
    ...
    Ok(Json(state.image_generator_manager.list_all_info().await))
}
...
pub async fn create_model(
    ...
    state.image_generator_manager.add_model(ImageGenerateModelRecord::from(payload)).await?;
...
pub async fn get_model(
    ...
    state.image_generator_manager.get_model(id).await
        .map(Json)
...
pub async fn update_model(
    ...
    state.image_generator_manager.update_model(id, ImageGenerateModelRecord::from(payload)).await?;
...
pub async fn delete_model(
    ...
    state.image_generator_manager.delete_model(id).await?;
    Ok(StatusCode::NO_CONTENT)
}
